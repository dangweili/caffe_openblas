...
// in this layer, there should no shuffle considering the multi-channels
template <typename Dtype>
...
void MultiImageDataLayer<Dtype>::InternalThreadEntry() {
  ...
  MultiImageDataParameter image_data_param = this->layer_param_.multiimage_data_param();
